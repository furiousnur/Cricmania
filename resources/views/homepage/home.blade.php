...
{{--    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">--}}
    ...
    <link rel="stylesheet" href="{{asset('assets/css/blueTheme.css')}}"/>
...
<div class="rca-container">
    ...
    <div class="rca-row">
        <div class="rca-column-12">
            <div class="rca-logo">
                <h2 align="center">
                    <span><img src="{{asset('assets/images/logo-01.svg')}}" style="width: 50px;"></span><span style="color: #ed4e4f;">CRICMANIA</span>
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="rca-row">
        ...
        <div class="rca-column-4" style="height: 80px;">
            <!--Live Season-->
            <div class="rca-menu-widget rca-live-season rca-left-border">
                <a href="{{ route('match.details',$item->id) }}" class="rca-padding">
                    <span class="rca-match-title rca-live-text">{{$item->t1}} vs {{ $item->t2 }} </span>
                    {{--<span class="rca-match-score">Ind 89/8 - 14.8(0)</span>
    ...
    <div align="right" class="col-lg-6">{{ $items->links() }}</div>
    ...
    <div class="rca-row">
        ...
        <div class="rca-column-5">
            ...
            <div class="rca-medium-widget rca-blog-content">
                <div class="rca-blog-image">
                    <a href="#">
                        <img src="{{asset('assets/')}}/images/Mahendra_Singh_Dhoni_batting.jpg">
                    </a>
                ...
                <div id="rtab-1" class="rca-padding rca-tab-content active">
                    <div class="rca-column-4">
                        <div class="rca-blog-content">
                            <div class="rca-blog-image">
                                <a href="#">
                                    <img src="{{asset('assets/')}}/images/1200px-IPL_T20_Chennai_vs_Kolkata.jpg">
                                </a>
                                <div class="rca-blog-head">
                    ...
                    <div class="rca-column-4">
                        <div class="rca-blog-content">
                            <div class="rca-blog-image">
                                <a href="#">
                                    <img src="{{asset('assets/')}}/images/1200px-Flagcricket.jpg">
                                </a>
                                <div class="rca-blog-head">
                                    Dhaka Platoon celebrate with the BPL trophy, after easing past Bangladesh in the final in Mirpur
                                </div>
                            </div>
                            <div class="rca-padding">
                    ...
                    <div class="rca-column-4">
                        <div class="rca-blog-content">
                            <div class="rca-blog-image">
                                <a href="#">
                                    <img src="{{asset('assets/')}}/images/Sachin_at_the_other_end.jpg">
                                </a>
                                <div class="rca-blog-head">
